...
@Component({
    ...
    template: `
        <p-dialog [(visible)]="visible" (visibleChange)="visibleChange.emit($event)" header="Đổi Tên Cột" [modal]="true" [appendTo]="'body'" [blockScroll]="true" [style]="{ width: '450px' }" maskStyleClass="backdrop-blur-sm" styleClass="!border-0">
            <div class="space-y-4">
                <div>
