...
@Component({
    ...
    template: `
        <div
            id="hero"
            class="relative flex flex-col pt-24 pb-12 px-6 lg:px-20 overflow-hidden"
            ...
            <div class="relative z-10 mx-auto max-w-7xl text-center">
                <div class="mb-6">
                    <span class="inline-block bg-white/20 text-white px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm">
                        Phiên bản 20.0.0 - Angular 20 & PrimeNG 20
                    </span>
                </div>
                ...
                <p class="font-normal text-xl md:text-2xl leading-relaxed text-white/90 max-w-3xl mx-auto mb-8">
                    Sakai-NG là template Angular hiện đại với PrimeNG, Tailwind CSS và thiết kế responsive. 
                    Bắt đầu dự án của bạn với foundation mạnh mẽ và UI components đẹp mắt.
                </p>
                <div class="flex gap-4 justify-center items-center flex-wrap">
                    ...
                    <button 
                        ...
                        label="Xem Demo" 
                        icon="pi pi-play"
                        class="text-xl! px-8! py-3! border-white! text-white! hover:bg-white/10! transition-all! duration-300!">
                    </button>
                </div>
            </div>
