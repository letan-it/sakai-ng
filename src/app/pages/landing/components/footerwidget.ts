...
@Component({
    ...
    template: `
        <div class="py-16 px-6 lg:px-20 bg-surface-50 dark:bg-surface-950 border-t border-surface-200 dark:border-surface-800">
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
                    <div class="md:col-span-4">
                        <a (click)="router.navigate(['/landing'], { fragment: 'home' })" class="flex items-center mb-6 cursor-pointer group">
                            <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 mr-3 group-hover:scale-110 transition-transform">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                    ...
                    <div class="md:col-span-8">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                            <div>
                                <h4 class="font-bold text-lg mb-4 text-surface-900 dark:text-surface-0">Company</h4>
                                <ul class="space-y-3">
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">About Us</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">News</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Careers</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Media Kit</a></li>
                                </ul>
                            </div>

                            <div>
                                <h4 class="font-bold text-lg mb-4 text-surface-900 dark:text-surface-0">Resources</h4>
                                <ul class="space-y-3">
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Get Started</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Documentation</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Learn</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Case Studies</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                <h4 class="font-bold text-lg mb-4 text-surface-900 dark:text-surface-0">Legal</h4>
                                <ul class="space-y-3">
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Brand Policy</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Privacy Policy</a></li>
                                    <li><a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Terms of Service</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-t border-surface-200 dark:border-surface-800 mt-12 pt-8">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div class="flex gap-6 text-sm">
                            ...
                            <a class="text-surface-600 dark:text-surface-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors cursor-pointer">Sitemap</a>
                        </div>
                    </div>
                </div>
            </div>
